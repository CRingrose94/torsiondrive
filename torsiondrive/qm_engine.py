...
class EngineOpenMM(QMEngine):
    ...
    def optimize_geomeTRIC(self):
        ...
        self.write_input()
        # set3
        self.run('geometric-optimize --prefix tdrive --qccnv true --epsilon 0.0 --enforce 0.1 --qdata --pdb '
...
class EnginePsi4(QMEngine):
    ...
    def optimize_geomeTRIC(self):
        ...
        self.write_input('input.dat')
        # step 3
        cmd = 'geometric-optimize --prefix tdrive --qccnv true --epsilon 0.0 --enforce 0.1 --qdata --psi4 input.dat constraints.txt'
